...
export function Settings() {
  ...
  const loadSettings = () => {
    try {
      const savedSettings = localStorage.getItem('visionweave_settings');
      if (savedSettings) {
  ...
  const testConnection = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Unable to reach VisionWeave API",
      });
    } finally {
      setIsTesting(false);
    }
      ...
      <div className="max-w-4xl mx-auto py-12 px-4 space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-xl text-muted-foreground">
            Configure your VisionWeave preferences and API settings
          </p>
        </div>
        ...
        <Card className="animate-fade-in">
          <CardHeader>
            ...
            <CardDescription>
              Current status of VisionWeave services
            </CardDescription>
          </CardHeader>
          <CardContent>
