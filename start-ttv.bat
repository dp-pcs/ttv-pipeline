@echo off
:: TTV Pipeline Launcher Script for Windows
...
:open_frontend
call :print_status "Opening TTV Pipeline Frontend..."
set "frontend_url=file:///%cd:\=/%/frontend/launcher.html"
start "" "!frontend_url!"
goto :eof
...
:stop_services
call :print_status "Stopping TTV Pipeline services..."
...
echo.
echo Examples:
echo   %~nx0              # Start system and open frontend
echo   %~nx0 start        # Start system only
...
if /i "%command%"=="start" (
    ...
    call :start_services
    call :open_frontend
    call :print_success "TTV Pipeline is ready!"
    echo.
    echo 🎬 Frontend: file:///%cd:\=/%/frontend/launcher.html
